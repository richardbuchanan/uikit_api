...
/**
 * @mainpage UIkit for Drupal API
 * Welcome to the UIkit for Drupal API. Newcomers to Drupal 7 theme
 ...
 * before reading the heavily-documented UIkit for Drupal topics below.
 *
 ...
 * UIkit for Drupal theme. To view the official UIkit framework API, please see
 ...
 * frameworks.
 *
 * With the mobile-first approach UIkit provides a consistent experience from
 * phones and tablets to desktops, without the need to worry about device sizes
 * and breakpoints.
 *
 * @section uikit_api UIkit for Drupal API Topics
