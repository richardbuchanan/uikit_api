 ...
 *
 * @gitcode
 * git clone --branch 8.x-2.x {username}@git.drupal.org:project/uikit.git
 * cd uikit
 * @endgitcode
 *
 * @divider
 ...
 * @link http://uikit-drupal.com/api/uikit/documentation%21uikit-8.x-2.x%21api%21maintainers.api.php/group/publish_release/8.x-2.x#release_notes_template Release Notes Template @endlink.
 * @endalert
 *
 ...
 * like this:
 *
 * @selectcode drush rn 8.x-2.0-beta1 origin/8.x-2.x --commit-links @endselectcode
 *
 ...
 * @selectcode This is a <strong>feature release in the UIkit 8.x-2.x series</strong> and is ready for use on production sites. @endselectcode
 *
 * @divider
 *
 ...
 * published:
 * - Release branch (i.e. 8.x-2.x, 7.x-3.x, etc.)
 ...
 * the latest stable release of the UIkit framework (currently 8.x-2.x and
 * 8.x-2.x).
 *
 * @divider
 *
 ...
 * (currently 8.x-2.x since 8.x-2.x is still under development).
 * @}
 */
