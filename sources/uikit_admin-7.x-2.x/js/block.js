...
Drupal.behaviors.blockDrag = {
  attach: function (context, settings) {
    ...
    Drupal.theme.tableDragChangedWarning = function () {
      return '<div class="uk-alert uk-alert-warning">' + Drupal.theme('tableDragChangedMarker') + ' ' + Drupal.t('The changes to these blocks will not be saved until the <em>Save blocks</em> button is clicked.') + '</div>';
    };
