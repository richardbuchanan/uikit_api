  ...
  Drupal.behaviors.contextualLinks = {
    attach: function (context) {
      $('div.contextual-links-wrapper', context).once('contextual-links', function () {
        ...
        var $trigger = $('<a class="contextual-links-trigger" href="#" />').html('<i class="uk-icon-cog uk-icon-small"><span class="uk-hidden">' + configure + '</span>').click(
          function () {
