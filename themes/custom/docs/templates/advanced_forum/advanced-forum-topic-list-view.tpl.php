...
?>
 <div id="forum-topic-list">
  ...
  <table class="forum-table forum-table-topics uk-table uk-table-hover uk-table-striped uk-table-condensed uk-table-middle <?php print $classes; ?>">
    <thead>
      <tr>
        ...
        <tr class="<?php print implode(' ', $row_classes[$count]); ?>">
          <?php if (empty($shadow[$count])): ?>
            <?php foreach ($row as $field => $content): ?>
              ...
              <td class="views-field views-field-<?php print $fields[$field]; ?> uk-position-relative">
          ...
          <?php else: ?> 
            ...
            <td class="views-field views-field-<?php print $fields['topic_icon']; ?> uk-position-relative">
