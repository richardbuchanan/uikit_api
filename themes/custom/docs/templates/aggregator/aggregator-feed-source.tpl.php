 ...
 */
?>
<div class="feed-source uk-margin-bottom">
  <?php print $source_icon; ?>
  <?php print $source_image; ?>
  <div class="feed-description">
    <?php print $source_description; ?>
  </div>
  <div class="feed-url uk-float-right uk-margin-right">
    <h3><a href="<?php print $source_url; ?>">View feed source</a></h3>
  </div>
  <div class="feed-updated">
    <?php print t('Last updated:'); ?> <?php print $last_checked; ?>
  </div>
</div>
